 ...
 */
export var BreadcrumbBase = /** @class */ (function (_super) {
    ...
    function BreadcrumbBase(props) {
        ...
        _this._onRenderBreadcrumb = function (data) {
            var _a, _b;
            var ariaLabel = (_a = data.props, _a.ariaLabel), DividerType = (_b = _a.dividerAs, _b === void 0 ? Icon : _b), onRenderItem = _a.onRenderItem, overflowAriaLabel = _a.overflowAriaLabel, overflowIndex = _a.overflowIndex, onRenderOverflowIcon = _a.onRenderOverflowIcon, overflowButtonAs = _a.overflowButtonAs;

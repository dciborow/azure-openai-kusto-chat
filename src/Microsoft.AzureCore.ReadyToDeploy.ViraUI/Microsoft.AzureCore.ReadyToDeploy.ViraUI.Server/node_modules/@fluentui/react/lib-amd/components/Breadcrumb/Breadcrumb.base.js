define(["require", "exports", "tslib", "react", "../../Utilities", "../../FocusZone", "../../Link", "../../Icon", "../../Button", "../../common/DirectionalHint", "../../ResizeGroup", "../../Tooltip", "../../Utilities"], function (require, exports, tslib_1, React, Utilities_1, FocusZone_1, Link_1, Icon_1, Button_1, DirectionalHint_1, ResizeGroup_1, Tooltip_1, Utilities_2) {
     ...
     */
    var BreadcrumbBase = exports.BreadcrumbBase = /** @class */ (function (_super) {
        ...
        function BreadcrumbBase(props) {
            ...
            _this._onGrowData = function (data) {
                var _a;
                var renderedItems = data.renderedItems, renderedOverflowItems = data.renderedOverflowItems;
                var overflowIndex = (_a = data.props, _a.overflowIndex), maxDisplayedItems = _a.maxDisplayedItems;
            ...
            _this._onRenderBreadcrumb = function (data) {
                var _a, _b;
                var ariaLabel = (_a = data.props, _a.ariaLabel), DividerType = (_b = _a.dividerAs, _b === void 0 ? Icon_1.Icon : _b), onRenderItem = _a.onRenderItem, overflowAriaLabel = _a.overflowAriaLabel, overflowIndex = _a.overflowIndex, onRenderOverflowIcon = _a.onRenderOverflowIcon, overflowButtonAs = _a.overflowButtonAs;
        ...
        BreadcrumbBase.prototype.render = function () {
            ...
            var onReduceData = (_a = this.props, _b = _a.onReduceData, _b === void 0 ? this._onReduceData : _b), onGrowData = (_c = _a.onGrowData, _c === void 0 ? this._onGrowData : _c), overflowIndex = _a.overflowIndex, maxDisplayedItems = _a.maxDisplayedItems, items = _a.items, className = _a.className, theme = _a.theme, styles = _a.styles;

            ...
            root: [
                ...
                (0, Styling_1.getFocusStyle)(theme, { borderColor: focusBorder, outlineColor: white }),
                {
                    ...
                    selectors: (_l = {},
                        ...
                        _l[".".concat(Utilities_1.IsFocusVisibleClassName, " &:focus .").concat(classNames.check, ", :host(.").concat(Utilities_1.IsFocusVisibleClassName, ") &:focus .").concat(classNames.check)] = {
                            opacity: 1,
                        },
                        _l['.ms-GroupSpacer'] = {
                            flexShrink: 0,

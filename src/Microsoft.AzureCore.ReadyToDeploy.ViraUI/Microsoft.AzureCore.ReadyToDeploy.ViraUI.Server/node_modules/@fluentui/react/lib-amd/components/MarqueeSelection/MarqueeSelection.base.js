define(["require", "exports", "tslib", "react", "../../Utilities", "@fluentui/react-window-provider", "../../utilities/dom"], function (require, exports, tslib_1, React, Utilities_1, react_window_provider_1, dom_1) {
     ...
     */
    var MarqueeSelectionBase = exports.MarqueeSelectionBase = /** @class */ (function (_super) {
        ...
        function MarqueeSelectionBase(props) {
            ...
            _this._onMouseDown = function (ev) {
                var _a;
                var isEnabled = (_a = _this.props, _a.isEnabled), onShouldStartSelection = _a.onShouldStartSelection;
        ...
        MarqueeSelectionBase.prototype.render = function () {
            var _a;
            var rootProps = (_a = this.props, _a.rootProps), children = _a.children, theme = _a.theme, className = _a.className, styles = _a.styles;

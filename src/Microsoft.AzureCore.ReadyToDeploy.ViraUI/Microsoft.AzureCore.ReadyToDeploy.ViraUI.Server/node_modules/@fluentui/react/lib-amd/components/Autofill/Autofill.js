define(["require", "exports", "tslib", "react", "../../Utilities", "@fluentui/react-window-provider"], function (require, exports, tslib_1, React, Utilities_1, react_window_provider_1) {
     ...
     */
    var Autofill = exports.Autofill = /** @class */ (function (_super) {
        ...
        Autofill.prototype.componentDidUpdate = function (_, _1, cursor) {
            ...
            var document = ((_b = this.context) === null || _b === void 0 ? void 0 : _b.window.document) || (0, Utilities_1.getDocument)(this._inputElement.current);

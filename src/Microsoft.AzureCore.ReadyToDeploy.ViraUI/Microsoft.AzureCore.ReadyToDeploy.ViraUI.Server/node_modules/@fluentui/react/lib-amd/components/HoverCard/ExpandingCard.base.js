define(["require", "exports", "tslib", "react", "../../Utilities", "./ExpandingCard.types", "./CardCallout/CardCallout"], function (require, exports, tslib_1, React, Utilities_1, ExpandingCard_types_1, CardCallout_1) {
    ...
    var ExpandingCardBase = exports.ExpandingCardBase = /** @class */ (function (_super) {
        ...
        ExpandingCardBase.prototype.render = function () {
            var _a, _b;
            var styles = (_a = this.props, _a.styles), compactCardHeight = _a.compactCardHeight, expandedCardHeight = _a.expandedCardHeight, theme = _a.theme, mode = _a.mode, className = _a.className;
            var needsScroll = (_b = this.state, _b.needsScroll), firstFrameRendered = _b.firstFrameRendered;

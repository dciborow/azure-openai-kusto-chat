define(["require", "exports", "tslib", "react", "@fluentui/utilities", "../Calendar/Calendar.types", "../CalendarDayGrid/CalendarDayGrid", "@fluentui/date-time-utilities", "../../Icon", "./defaults"], function (require, exports, tslib_1, React, utilities_1, Calendar_types_1, CalendarDayGrid_1, date_time_utilities_1, Icon_1, defaults_1) {
    ...
    var WeeklyDayPickerBase = exports.WeeklyDayPickerBase = /** @class */ (function (_super) {
        ...
        function WeeklyDayPickerBase(props) {
            ...
            _this._renderPreviousWeekNavigationButton = function (classNames) {
                var _a, _b;
                var minDate = (_a = _this.props, _a.minDate), firstDayOfWeek = _a.firstDayOfWeek, navigationIcons = _a.navigationIcons;
                ...
                var prevWeekInBounds = minDate
                    ...
                    : true;
                return (React.createElement("button", { className: (0, utilities_1.css)(classNames.navigationIconButton, (_b = {},
                        _b[classNames.disabledStyle] = !prevWeekInBounds,
                        _b)), disabled: !prevWeekInBounds, "aria-disabled": !prevWeekInBounds, onClick: prevWeekInBounds ? _this._onSelectPrevDateRange : undefined, onKeyDown: prevWeekInBounds ? _this._onButtonKeyDown(_this._onSelectPrevDateRange) : undefined, title: _this._createPreviousWeekAriaLabel(), type: "button" },
                    React.createElement(Icon_1.Icon, { iconName: leftNavigationIcon })));
            };
            _this._renderNextWeekNavigationButton = function (classNames) {
                var _a, _b;
                var maxDate = (_a = _this.props, _a.maxDate), firstDayOfWeek = _a.firstDayOfWeek, navigationIcons = _a.navigationIcons;
                var navigatedDate = _this.state.navigatedDate;
                ...
                var nextWeekInBounds = maxDate
                    ...
                    : true;
                return (React.createElement("button", { className: (0, utilities_1.css)(classNames.navigationIconButton, (_b = {},
                        _b[classNames.disabledStyle] = !nextWeekInBounds,
                        _b)), disabled: !nextWeekInBounds, "aria-disabled": !nextWeekInBounds, onClick: nextWeekInBounds ? _this._onSelectNextDateRange : undefined, onKeyDown: nextWeekInBounds ? _this._onButtonKeyDown(_this._onSelectNextDateRange) : undefined, title: _this._createNextWeekAriaLabel(), type: "button" },
            ...
            _this._createPreviousWeekAriaLabel = function () {
                var _a;
                var strings = (_a = _this.props, _a.strings), showFullMonth = _a.showFullMonth, firstDayOfWeek = _a.firstDayOfWeek;
                var navigatedDate = _this.state.navigatedDate;
            ...
            _this._formatDateRange = function (startDate, endDate) {
                var _a;
                var dateTimeFormatter = (_a = _this.props, _a.dateTimeFormatter), strings = _a.strings;

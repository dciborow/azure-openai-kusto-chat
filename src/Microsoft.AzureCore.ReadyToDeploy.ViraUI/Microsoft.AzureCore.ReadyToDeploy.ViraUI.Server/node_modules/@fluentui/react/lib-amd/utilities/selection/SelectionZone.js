define(["require", "exports", "tslib", "react", "../../Utilities", "./interfaces"], function (require, exports, tslib_1, React, Utilities_1, interfaces_1) {
     ...
     */
    var SelectionZone = exports.SelectionZone = /** @class */ (function (_super) {
        ...
        SelectionZone.prototype._getSelectionMode = function () {
            var _a;
            var selection = this.props.selection;
            var selectionMode = (_a = this.props.selectionMode, _a === void 0 ? selection ? selection.mode : interfaces_1.SelectionMode.none : _a);

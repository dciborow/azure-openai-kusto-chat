    ...
    var splitButtonStyles = {
        splitButtonContainer: [
            (0, Styling_1.getFocusStyle)(theme, { highContrastStyle: buttonHighContrastFocus, inset: 2, pointerEvents: 'none' }),
            {
                ...
                '.ms-Button--primary + .ms-Button': (_d = {
                    ...
                    _d),
                '.ms-Button--primary + .ms-Button[aria-expanded="true"]': tslib_1.__assign(tslib_1.__assign({ backgroundColor: 'Highlight', borderColor: 'Highlight', color: 'HighlightText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()), { '.ms-Button-menuIcon': {
                        color: 'HighlightText',
                    } }),
        ...
        splitButtonContainerChecked: {
            '.ms-Button--primary': (_h = {},
                _h[Styling_1.HighContrastSelector] = tslib_1.__assign({ color: 'Window', backgroundColor: 'WindowText' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
                _h),
        },
        ...
        splitButtonMenuButton: (_k = {
            ...
            _k),
        splitButtonDivider: tslib_1.__assign(tslib_1.__assign({}, splitButtonDividerBaseStyles), (_l = {}, _l[Styling_1.HighContrastSelector] = {
            backgroundColor: 'WindowText',
        }, _l)),
        splitButtonDividerDisabled: tslib_1.__assign(tslib_1.__assign({}, splitButtonDividerBaseStyles), (_m = {}, _m[Styling_1.HighContrastSelector] = {
        ...
        splitButtonContainerDisabled: (_r = {
            ...
            _r[Styling_1.HighContrastSelector] = tslib_1.__assign({ color: 'GrayText', borderColor: 'GrayText', backgroundColor: 'Window' }, (0, Styling_1.getHighContrastNoAdjustStyle)()),
            _r),

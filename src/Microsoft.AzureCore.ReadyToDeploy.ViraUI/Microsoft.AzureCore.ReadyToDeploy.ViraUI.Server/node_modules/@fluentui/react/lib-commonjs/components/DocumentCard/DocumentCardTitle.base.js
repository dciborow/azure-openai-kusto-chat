 ...
 */
var DocumentCardTitleBase = exports.DocumentCardTitleBase = /** @class */ (function (_super) {
    ...
    function DocumentCardTitleBase(props) {
        ...
        _this._shrinkTitle = function () {
            var _a;
            var truncatedTitleFirstPiece = (_a = _this.state, _a.truncatedTitleFirstPiece), truncatedTitleSecondPiece = _a.truncatedTitleSecondPiece;
    ...
    DocumentCardTitleBase.prototype.render = function () {
        var _a, _b;
        var _this = this;
        var title = (_a = this.props, _a.title), shouldTruncate = _a.shouldTruncate, showAsSecondaryTitle = _a.showAsSecondaryTitle, styles = _a.styles, theme = _a.theme, className = _a.className;
        var truncatedTitleFirstPiece = (_b = this.state, _b.truncatedTitleFirstPiece), truncatedTitleSecondPiece = _b.truncatedTitleSecondPiece;

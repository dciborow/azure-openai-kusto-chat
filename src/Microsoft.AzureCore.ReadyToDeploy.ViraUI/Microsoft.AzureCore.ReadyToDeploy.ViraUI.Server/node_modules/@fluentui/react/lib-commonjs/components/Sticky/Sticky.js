...
var Sticky = exports.Sticky = /** @class */ (function (_super) {
    ...
    Sticky.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        var isStickyBottom = (_a = this.state, _a.isStickyBottom), isStickyTop = _a.isStickyTop, distanceFromTop = _a.distanceFromTop;
    ...
    Sticky.prototype.shouldComponentUpdate = function (nextProps, nextState) {
        ...
        var isStickyTop = (_a = this.state, _a.isStickyTop), isStickyBottom = _a.isStickyBottom, distanceFromTop = _a.distanceFromTop;
    ...
    Sticky.prototype.render = function () {
        var _a, _b;
        var isStickyTop = (_a = this.state, _a.isStickyTop), isStickyBottom = _a.isStickyBottom;
        var stickyClassName = (_b = this.props, _b.stickyClassName), children = _b.children;
        if (!this.context.scrollablePane) {

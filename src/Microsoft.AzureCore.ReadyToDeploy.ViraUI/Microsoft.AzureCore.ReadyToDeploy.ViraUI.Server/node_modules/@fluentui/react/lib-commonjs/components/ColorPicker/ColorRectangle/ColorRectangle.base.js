 ...
 */
var ColorRectangleBase = exports.ColorRectangleBase = /** @class */ (function (_super) {
    ...
    ColorRectangleBase.prototype.render = function () {
        var _a;
        var minSize = (_a = this.props, _a.minSize), theme = _a.theme, className = _a.className, styles = _a.styles, ariaValueFormat = _a.ariaValueFormat, ariaLabel = _a.ariaLabel, ariaDescription = _a.ariaDescription;
